function put_leitura(url, token, chave_leitura, leitura_consolidada, nu_valida) {

  var request = new XMLHttpRequest();

  url = url + '?id_leitura_cd=' + chave_leitura + "&leitura_consistida=" + leitura_consolidada + "&ic_leitura_valida=" + nu_valida
...
function gravar_leitura_consistida() {
  ...
  put_leitura(url, token, chave_leitura, leitura_consolidada, nu_valida);
